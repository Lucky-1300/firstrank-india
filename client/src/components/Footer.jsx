...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-950 text-white mt-16 sm:mt-24">
      {/* Main Footer */}
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              {socials.map((icon, i) => (
                <button
                  key={i}
                  className="w-10 h-10 rounded-full bg-gray-900 hover:bg-orange-500 transition flex items-center justify-center text-sm"
                >
                  {icon}
                </button>
              ))}
